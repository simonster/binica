...
/* Number of double elements in the PVM assign buffer */
#define ASSIGN_NDBL       5

/* Double elements in the PVM assign buffer */
...
/* Number of integer elements in the PVM result buffer */
#define RESULT_NINT  4

/* Integer elements in the PVM result buffer */
#define RESULT_ID    0
...
extern int slave();
extern void pvmica(doublereal*, doublereal*, doublereal*, doublereal*, integer, integer, integer, integer, int*, doublereal*, integer*, char**);
